...
namespace DaCollector.Abstractions.Utilities;
...
public static class UuidUtility
{
    ...
    public readonly struct PublicUuidNamespaces
    {
        ...
        /// <summary>
        /// DaCollector plugins namespace.
        /// </summary>
        public static readonly Guid DaCollectorPluginAbstractions = GetV5("DaCollector.Abstractions", OID);
    }
    ...
    private static readonly Dictionary<Guid, byte[]> _namespaceIDs = new()
    {
        ...
        { PublicUuidNamespaces.DaCollectorPluginAbstractions, Convert.FromHexString(PublicUuidNamespaces.DaCollectorPluginAbstractions.ToString().Replace("-", "")) },
    };
    ...
    public static Guid GetV3(byte[] input, Guid namespaceGuid = default)
    {
        if (namespaceGuid == default)
            namespaceGuid = PublicUuidNamespaces.DaCollectorPluginAbstractions;
