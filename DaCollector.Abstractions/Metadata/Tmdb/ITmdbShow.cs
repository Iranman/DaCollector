...
public interface ITmdbShow : ISeries, IWithCreationDate, IWithUpdateDate
{
    ...
    /// <summary>
    /// All DaCollector series ↔ TMDB show cross references linked to the TMDB show.
    /// </summary>
    IReadOnlyList<ITmdbShowCrossReference> TmdbShowCrossReferences { get; }

    /// <summary>
    /// All DaCollector series ↔ TMDB season cross references linked to the TMDB show.
    /// </summary>
    IReadOnlyList<ITmdbSeasonCrossReference> TmdbSeasonCrossReferences { get; }

    /// <summary>
    /// All DaCollector episode ↔ TMDB episode cross references linked to the TMDB show.
    /// </summary>
