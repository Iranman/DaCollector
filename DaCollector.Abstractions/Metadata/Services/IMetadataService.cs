...
namespace DaCollector.Abstractions.Metadata.Services;

/// <summary>
/// Provides functionality for interacting with metadata from various providers,
/// including DaCollector and other providers.
/// </summary>
public interface IMetadataService
{
    ...
    /// <summary>
    /// Looks up all dacollector episodes as an enumerable list.
    /// </summary>
    /// <returns>A collection of episodes if found, otherwise an empty collection.</returns>
    IEnumerable<IDaCollectorEpisode> GetAllDaCollectorEpisodes();

    /// <summary>
    /// Looks up a dacollector episode by its ID.
    /// </summary>
    /// <param name="episodeID">The ID of the episode.</param>
    /// <returns>The episode if found, otherwise <see langword="null"/>.</returns>
    IDaCollectorEpisode? GetDaCollectorEpisodeByID(int episodeID);

    /// <summary>
    /// Looks up a dacollector episode by its AniDB ID.
    /// </summary>
    /// <param name="anidbEpisodeID">The AniDB ID of the episode.</param>
    /// <returns>The episode if found, otherwise <see langword="null"/>.</returns>
    IDaCollectorEpisode? GetDaCollectorEpisodeByAnidbID(int anidbEpisodeID);
    ...
    /// <summary>
    /// Looks up all dacollector series as an enumerable list.
    /// </summary>
    /// <returns>A collection of series if found, otherwise an empty collection.</returns>
    IEnumerable<IDaCollectorSeries> GetAllDaCollectorSeries();

    /// <summary>
    /// Looks up a dacollector series by its ID.
    /// </summary>
    /// <param name="seriesID">The ID of the series.</param>
    /// <returns>The series if found, otherwise <see langword="null"/>.</returns>
    IDaCollectorSeries? GetDaCollectorSeriesByID(int seriesID);

    /// <summary>
    /// Looks up a dacollector series by its AniDB ID.
    /// </summary>
    /// <param name="anidbSeriesID">The AniDB ID of the series.</param>
    /// <returns>The series if found, otherwise <see langword="null"/>.</returns>
    IDaCollectorSeries? GetDaCollectorSeriesByAnidbID(int anidbSeriesID);
    ...
    IEnumerable<IDaCollectorTag> GetAllCustomTags();
    ...
    IDaCollectorTag? GetCustomTagByID(int tagID);
    ...
    IDaCollectorTag CreateCustomTag(string name, string? description = null);
    ...
    IDaCollectorTag UpdateCustomTag(IDaCollectorTag tag, string? name = null, string? description = null);

    /// <summary>
    /// Deletes a custom tag, and removes it from all series.
    /// </summary>
    /// <param name="tag">The custom tag to delete.</param>
    void DeleteCustomTag(IDaCollectorTag tag);
    ...
    bool AddCustomTagsToSeries(IDaCollectorSeries series, IEnumerable<IDaCollectorTag> tags);
    ...
    bool RemoveCustomTagsFromSeries(IDaCollectorSeries series, IEnumerable<IDaCollectorTag> tags);
    ...
    bool ClearCustomTagsForSeries(IDaCollectorSeries series);
    ...
    /// <summary>
    /// Looks up all dacollector groups as an enumerable list.
    /// </summary>
    /// <returns>A collection of groups if found, otherwise an empty collection.</returns>
    IEnumerable<IDaCollectorGroup> GetAllDaCollectorGroups();

    /// <summary>
    /// Looks up a dacollector group by its ID.
    /// </summary>
    /// <param name="groupID">The ID of the group.</param>
    /// <returns>The group if found, otherwise <see langword="null"/>.</returns>
    IDaCollectorGroup? GetDaCollectorGroupByID(int groupID);
