...
public class VideoFileRelocatedEventArgs : VideoFileEventArgs
{
    ...
    public VideoFileRelocatedEventArgs(string relativePath, IManagedFolder managedFolder, string previousRelativePath, IManagedFolder previousManagedFolder, IVideoFile fileInfo, IVideo videoInfo, IEnumerable<IDaCollectorEpisode> episodeInfo, IEnumerable<IDaCollectorSeries> animeInfo, IEnumerable<IDaCollectorGroup> groupInfo)
