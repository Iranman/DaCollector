...
namespace DaCollector.Abstractions.Plugin;
...
public interface IPlugin
{
    ...
    ///   "assets/Thumbnail.png" for the example plugin "DaCollector.Plugin.Example"
    ///   would be:
    ///   <code>
    ///   "DaCollector.Plugin.Example.assets.Thumbnail.png"
    ///   </code>
    /// </example>
