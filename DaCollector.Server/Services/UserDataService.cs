...
) : IUserDataService
{
            ...
            if (!userDataUpdate.NoEpisodePropagation)
            {
                ...
                if (userDataUpdate.LastPlayedAt.HasValue)
                {
                    foreach (var episodeXref in xrefs)
                    {
                        ...
                        if (episodeXref.DaCollectorEpisode is not { } episode)
                            continue;
    ...
    public IEpisodeUserData GetEpisodeUserData(IDaCollectorEpisode episode, IUser user)
    {
    ...
    public IReadOnlyList<IEpisodeUserData> GetEpisodeUserDataForEpisode(IDaCollectorEpisode episode)
    {
        ArgumentNullException.ThrowIfNull(episode);
        if (episode.ID is <= 0)
            throw new ArgumentException("episode.ID must be greater than 0.", nameof(episode));
    ...
    public Task<IEpisodeUserData> RateEpisode(IDaCollectorEpisode episode, IUser user, double? userRating)
    {
        ArgumentNullException.ThrowIfNull(episode);
        if (episode.ID is <= 0)
            throw new ArgumentException("episode.ID must be greater than 0.", nameof(episode));
    ...
    public Task<IEpisodeUserData> UnrateEpisode(IDaCollectorEpisode episode, IUser user)
        => SaveEpisodeUserDataInternal(episode, user, new EpisodeUserDataUpdate { UserRating = null });

    public Task<IEpisodeUserData> ToggleEpisodeAsFavorite(IDaCollectorEpisode episode, IUser user)
    ...
    public Task<IEpisodeUserData> SetEpisodeAsFavorite(IDaCollectorEpisode episode, IUser user, bool value)
        => SaveEpisodeUserDataInternal(episode, user, new EpisodeUserDataUpdate { IsFavorite = value });

    public Task<IEpisodeUserData> AddUserTagsForEpisode(IDaCollectorEpisode episode, IUser user, params string[] tags)
    ...
    public Task<IEpisodeUserData> AddUserTagsForEpisode(IDaCollectorEpisode episode, IUser user, IEnumerable<string>? tags)
        => SaveEpisodeUserDataInternal(episode, user, new EpisodeUserDataUpdate { UserTags = (episodeUserDataRepository.GetByUserAndEpisodeID(user.ID, episode.ID)?.UserTags ?? []).Union(tags ?? []) });

    public Task<IEpisodeUserData> RemoveUserTagsForEpisode(IDaCollectorEpisode episode, IUser user, params string[] tags)
    ...
    public Task<IEpisodeUserData> RemoveUserTagsForEpisode(IDaCollectorEpisode episode, IUser user, IEnumerable<string>? tags)
        => SaveEpisodeUserDataInternal(episode, user, new EpisodeUserDataUpdate { UserTags = (episodeUserDataRepository.GetByUserAndEpisodeID(user.ID, episode.ID)?.UserTags ?? []).Except(tags ?? []) });

    public Task<IEpisodeUserData> SetUserTagsForEpisode(IDaCollectorEpisode episode, IUser user, IEnumerable<string>? tags)
        => SaveEpisodeUserDataInternal(episode, user, new EpisodeUserDataUpdate { UserTags = tags });

    public Task<IEpisodeUserData> SetEpisodeWatchedStatus(IDaCollectorEpisode episode, IUser user, bool watched = true, DateTime? watchedAt = null, VideoUserDataSaveReason reason = VideoUserDataSaveReason.None, bool noVideoPropagation = false, bool updateStatsNow = true)
    ...
    public Task<IEpisodeUserData> SaveEpisodeUserData(IDaCollectorEpisode episode, IUser user, EpisodeUserDataUpdate userDataUpdate, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None, bool updateStatsNow = true)
        => SaveEpisodeUserDataInternal(episode, user, userDataUpdate, null, videoReason, updateStatsNow);

    public Task<IEpisodeUserData> ImportEpisodeUserData(IDaCollectorEpisode episode, IUser user, EpisodeUserDataUpdate userDataUpdate, string importSource, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None, bool updateStatsNow = true)
        => SaveEpisodeUserDataInternal(episode, user, userDataUpdate, importSource, videoReason, updateStatsNow);

    private async Task<IEpisodeUserData> SaveEpisodeUserDataInternal(IDaCollectorEpisode episode, IUser user, EpisodeUserDataUpdate userDataUpdate, string? importSource = null, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None, bool updateStatsNow = true)
    {
        ArgumentNullException.ThrowIfNull(episode);
        ArgumentNullException.ThrowIfNull(user);
    ...
    private void SendEvent(IDaCollectorEpisode episode, IUser user, IEpisodeUserData userData, EpisodeUserDataSaveReason reason, string? importSource, VideoUserDataSaveReason videoReason)
    {
        Task.Run(() =>
        {
    ...
    internal async Task IncrementEpisodeStats(IDaCollectorEpisode episode, IUser user, int statCountType)
    {
    ...
    internal void CreateUserRecordsForNewEpisode(IDaCollectorEpisode episode)
    {
    ...
    public ISeriesUserData GetSeriesUserData(IDaCollectorSeries series, IUser user)
    {
    ...
    public IReadOnlyList<ISeriesUserData> GetSeriesUserDataForSeries(IDaCollectorSeries series)
    {
        ArgumentNullException.ThrowIfNull(series);
        if (series.ID is <= 0)
            throw new ArgumentException("series.ID must be greater than 0.", nameof(series));
    ...
    public Task<ISeriesUserData> RateSeries(IDaCollectorSeries series, IUser user, double? userRating, SeriesVoteType? voteType = null)
    {
        ArgumentNullException.ThrowIfNull(series);
        if (series.ID is <= 0)
            throw new ArgumentException("series.ID must be greater than 0.", nameof(series));
    ...
    public Task<ISeriesUserData> UnrateSeries(IDaCollectorSeries series, IUser user)
        => SaveSeriesUserDataInternal(series, user, new SeriesUserDataUpdate { UserRating = null });

    public Task<ISeriesUserData> ToggleSeriesAsFavorite(IDaCollectorSeries series, IUser user)
    ...
    public Task<ISeriesUserData> SetSeriesAsFavorite(IDaCollectorSeries series, IUser user, bool value)
        => SaveSeriesUserDataInternal(series, user, new SeriesUserDataUpdate { IsFavorite = value });

    public Task<ISeriesUserData> AddUserTagsForSeries(IDaCollectorSeries series, IUser user, params string[] tags)
    ...
    public Task<ISeriesUserData> AddUserTagsForSeries(IDaCollectorSeries series, IUser user, IEnumerable<string>? tags)
        => SaveSeriesUserDataInternal(series, user, new SeriesUserDataUpdate { UserTags = (seriesUserDataRepository.GetByUserAndSeriesID(user.ID, series.ID)?.UserTags ?? []).Union(tags ?? []) });

    public Task<ISeriesUserData> RemoveUserTagsForSeries(IDaCollectorSeries series, IUser user, params string[] tags)
    ...
    public Task<ISeriesUserData> RemoveUserTagsForSeries(IDaCollectorSeries series, IUser user, IEnumerable<string>? tags)
        => SaveSeriesUserDataInternal(series, user, new SeriesUserDataUpdate { UserTags = (seriesUserDataRepository.GetByUserAndSeriesID(user.ID, series.ID)?.UserTags ?? []).Except(tags ?? []) });

    public Task<ISeriesUserData> SetUserTagsForSeries(IDaCollectorSeries series, IUser user, IEnumerable<string>? tags)
        => SaveSeriesUserDataInternal(series, user, new SeriesUserDataUpdate { UserTags = tags });

    public Task<ISeriesUserData> SaveSeriesUserData(IDaCollectorSeries series, IUser user, SeriesUserDataUpdate userDataUpdate, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None)
        => SaveSeriesUserDataInternal(series, user, userDataUpdate);

    public Task<ISeriesUserData> ImportSeriesUserData(IDaCollectorSeries series, IUser user, SeriesUserDataUpdate userDataUpdate, string importSource, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None)
        => SaveSeriesUserDataInternal(series, user, userDataUpdate, importSource);

    private async Task<ISeriesUserData> SaveSeriesUserDataInternal(IDaCollectorSeries series, IUser user, SeriesUserDataUpdate userDataUpdate, string? importSource = null, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None)
    {
        var reason = string.IsNullOrEmpty(importSource)
    ...
    internal void UpdateWatchedStats(IDaCollectorSeries series, IReadOnlyList<IDaCollectorEpisode> episodes)
    {
    ...
    private void UpdateWatchedStats(IDaCollectorSeries series, IUser user, VideoUserDataSaveReason reason = VideoUserDataSaveReason.None)
    {
    ...
    private void UpdateWatchedStatsInternal(
        IDaCollectorSeries series,
        IReadOnlyList<IDaCollectorEpisode> episodes,
        IUser user,
    ...
    private void SendEvent(IDaCollectorSeries series, IUser user, ISeriesUserData userData, SeriesUserDataSaveReason reason, string? importSource = null, VideoUserDataSaveReason videoReason = VideoUserDataSaveReason.None)
    {
        Task.Run(() =>
        {
