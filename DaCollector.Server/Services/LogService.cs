...
using DaCollector.Server.API.SignalR.NLog;
using DaCollector.Server.Extensions;
using DaCollector.Server.Logging;
...
public class LogService(ILogger<LogService> logger, IApplicationPaths applicationPaths, ISettingsProvider settingsProvider) : ILogService
{
    ...
    private static IReadOnlyList<LogLevelRuleConfiguration> GetDefaultLogLevelRules()
        => [
            ...
            new() { LoggerNamePattern = "DaCollector.Server.Scheduling.ThreadPooledJobStore", MaxLevel = ELogLevel.Information, Final = true },
            new() { LoggerNamePattern = "DaCollector.Server.Scheduling.Delegates.*", MaxLevel = ELogLevel.Information, Final = true },
            new() { LoggerNamePattern = "DaCollector.Server.API.Authentication.CustomAuthHandler", MaxLevel = ELogLevel.Information, Final = true },
