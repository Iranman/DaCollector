...
using DaCollector.Server.Utilities.FileSystemWatcher;
...
public class FileWatcherService
{
    ...
    private readonly DaCollectorManagedFolderRepository _managedFolders;
    ...
    public FileWatcherService(ILogger<FileWatcherService> logger, ConfigurationProvider<ServerSettings> settingsProvider, DaCollectorManagedFolderRepository managedFolders)
    {
        _logger = logger;
