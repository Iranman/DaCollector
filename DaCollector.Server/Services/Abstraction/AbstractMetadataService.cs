...
#nullable enable
namespace DaCollector.Server.Services.Abstraction;
...
public partial class AbstractMetadataService : IMetadataService
{
    ...
    )
    {
        ...
        DaCollectorEventHandler.Instance.SeriesUpdated += OnSeriesUpdated;
        DaCollectorEventHandler.Instance.SeasonUpdated += OnSeasonUpdated;
        DaCollectorEventHandler.Instance.EpisodeUpdated += OnEpisodeUpdated;
        DaCollectorEventHandler.Instance.MovieUpdated += OnMovieUpdated;
    }
    ...
    public IEnumerable<IMovie> GetAllMoviesForProvider(IMetadataService.ProviderName providerName)
        => providerName switch
        {
            IMetadataService.ProviderName.DaCollector => [],
    ...
    public IMovie? GetMovieByProviderID(int providerID, IMetadataService.ProviderName providerName)
        ...
        {
            IMetadataService.ProviderName.DaCollector => null,
    ...
    public IEnumerable<IEpisode> GetAllEpisodesForProvider(IMetadataService.ProviderName providerName)
        => providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _episodeRepository.GetAll(),
    ...
    public IEpisode? GetEpisodeByProviderID(int providerID, IMetadataService.ProviderName providerName)
        => providerID <= 0 ? null : providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _episodeRepository.GetByID(providerID),
    ...
    /// <inheritdoc />
    public IEnumerable<IDaCollectorEpisode> GetAllDaCollectorEpisodes()
        => _episodeRepository.GetAll();

    /// <inheritdoc />
    public IDaCollectorEpisode? GetDaCollectorEpisodeByID(int episodeID)
        => episodeID <= 0 ? null : _episodeRepository.GetByID(episodeID);

    /// <inheritdoc />
    public IDaCollectorEpisode? GetDaCollectorEpisodeByAnidbID(int anidbEpisodeID)
    ...
    public IEnumerable<ISeries> GetAllSeriesForProvider(IMetadataService.ProviderName providerName)
        => providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _seriesRepository.GetAll(),
    ...
    public ISeries? GetSeriesByProviderID(int providerID, IMetadataService.ProviderName providerName)
        => providerID <= 0 ? null : providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _seriesRepository.GetByID(providerID),
    ...
    /// <inheritdoc />
    public IEnumerable<IDaCollectorSeries> GetAllDaCollectorSeries()
        => _seriesRepository.GetAll();

    /// <inheritdoc />
    public IDaCollectorSeries? GetDaCollectorSeriesByID(int seriesID)
        => seriesID <= 0 ? null : _seriesRepository.GetByID(seriesID);

    /// <inheritdoc />
    public IDaCollectorSeries? GetDaCollectorSeriesByAnidbID(int anidbSeriesID)
        => anidbSeriesID <= 0 ? null : _seriesRepository.GetByAnimeID(anidbSeriesID);

    #region Series | Custom Tags

    /// <inheritdoc />
    public IEnumerable<IDaCollectorTag> GetAllCustomTags()
        => _customTagRepository.GetAll();

    /// <inheritdoc />
    public IDaCollectorTag? GetCustomTagByID(int tagID)
        => tagID <= 0 ? null : _customTagRepository.GetByID(tagID);

    /// <inheritdoc />
    public IDaCollectorTag CreateCustomTag(string name, string? description = null)
    {
    ...
    public IDaCollectorTag UpdateCustomTag(IDaCollectorTag tag, string? name = null, string? description = null)
    {
    ...
    /// <inheritdoc />
    public void DeleteCustomTag(IDaCollectorTag tag)
    {
    ...
    /// <inheritdoc />
    public bool AddCustomTagsToSeries(IDaCollectorSeries series, IEnumerable<IDaCollectorTag> tags)
    {
        ...
        tagList = tagList
            .Select(x => x is CustomTag or AnimeTag ? _customTagRepository.GetByID(x.ID) as IDaCollectorTag : null)
            .WhereNotNull()
            .ToList();
    ...
    /// <inheritdoc />
    public bool RemoveCustomTagsFromSeries(IDaCollectorSeries series, IEnumerable<IDaCollectorTag> tags)
    {
        ArgumentNullException.ThrowIfNull(series);
        ArgumentNullException.ThrowIfNull(tags);
        var tagList = tags.ToList();
    ...
    /// <inheritdoc />
    public bool ClearCustomTagsForSeries(IDaCollectorSeries series)
    {
        ArgumentNullException.ThrowIfNull(series);
        var existingTagIds = _customTagXrefRepository.GetByAnimeID(series.AnidbAnimeID);
    ...
    public IEnumerable<ICollection> GetAllCollectionsForProvider(IMetadataService.ProviderName providerName)
        => providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _groupRepository.GetAll(),
            IMetadataService.ProviderName.AniDB => [],
    ...
    public ICollection? GetCollectionByProviderID(int providerID, IMetadataService.ProviderName providerName)
        => providerID <= 0 ? null : providerName switch
        {
            IMetadataService.ProviderName.DaCollector => _groupRepository.GetByID(providerID),
            IMetadataService.ProviderName.AniDB => null,
    ...
    /// <inheritdoc />
    public IEnumerable<IDaCollectorGroup> GetAllDaCollectorGroups()
        => _groupRepository.GetAll();

    /// <inheritdoc />
    public IDaCollectorGroup? GetDaCollectorGroupByID(int groupID)
