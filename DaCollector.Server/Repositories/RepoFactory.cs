...
using DaCollector.Server.Repositories.Direct.TMDB.Text;
...
public class RepoFactory
{
    ...
    public static DaCollectorManagedFolderRepository DaCollectorManagedFolder;
    ...
    public RepoFactory(
        ...
        DaCollectorManagedFolderRepository dacollectorManagedFolder,
    ...
    )
    {
        ...
        DaCollectorManagedFolder = dacollectorManagedFolder;
