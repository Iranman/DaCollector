...
using DaCollector.Server.Plex.Models.Login;
using DaCollector.Server.Plugin;
using DaCollector.Server.Repositories;
using DaCollector.Server.Utilities;

using Directory = DaCollector.Server.Plex.Models.Libraries.Directory;
using MediaContainer = DaCollector.Server.Plex.Models.Connections.MediaContainer;
...
public class PlexHelper
{
    ...
    public string LoginUrl => $"https://app.plex.tv/auth#?clientID={ClientIdentifier}" +
                              $"&code={GetPlexKey().Code}"; /* +
                                  "&context%5Bdevice%5D%5Bproduct%5D=DaCollector%20Server" +
        ...
        Action<HttpRequestMessage> configureRequest = null)
    {
        ...
        client.DefaultRequestHeaders.Add("X-Plex-Platform", "DaCollector");
        client.DefaultRequestHeaders.Add("X-Plex-Device-Name", "DaCollector Sync");
        client.DefaultRequestHeaders.Add("X-Plex-Product", "DaCollector Sync");
        client.DefaultRequestHeaders.Add("X-Plex-Device", "DaCollector");
    ...
    public Directory[] GetDirectories()
    {
        ...
        try
        {
            ...
            return JsonConvert
                .DeserializeObject<MediaContainer<DaCollector.Server.Plex.Models.Libraries.MediaContainer>>(data, SerializerSettings)
