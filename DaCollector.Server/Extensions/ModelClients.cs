...
#pragma warning restore CS0618
    ...
    public static DataSource ToServerSource(this CL_ImageEntityType type)
        => type switch
        {
            ...
            CL_ImageEntityType.Character => DataSource.DaCollector,
            CL_ImageEntityType.MovieDB_FanArt => DataSource.TMDB,
            CL_ImageEntityType.MovieDB_Poster => DataSource.TMDB,
            CL_ImageEntityType.Staff => DataSource.DaCollector,
    ...
    public static CL_ImageEntityType ToClient(this ImageEntityType imageType, DataSource source)
        => source switch
        {
            ...
            DataSource.DaCollector => imageType switch
            {
    ...
    public static CL_ImportFolder ToClient(this DaCollectorManagedFolder mf)
        => new()
        {
    ...
    public static DaCollectorManagedFolder ToServer(this CL_ImportFolder mf)
        => new()
        {
