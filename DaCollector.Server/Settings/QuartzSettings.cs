...
public class QuartzSettings
{
    ...
    /// <summary>
    /// A map of Type (yes, you need to look at the source code, under ./DaCollector.Server/Scheduling/Jobs) to the number of allowed concurrent jobs of the same type.
