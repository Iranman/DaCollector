...
public class ServerSettings : IServerSettings, INewtonsoftJsonConfiguration, IHiddenConfiguration, IConfigurationWithMigrations, IConfigurationWithCustomValidation<ServerSettings>
{
    ...
    /// <inheritdoc />
    [EnvironmentVariable("DACOLLECTOR_IMAGES_PATH", AllowOverride = true)]
    [RequiresRestart]
    ...
    /// <inheritdoc />
    [EnvironmentVariable("DACOLLECTOR_FIRST_RUN", AllowOverride = true)]
    [Visibility(DisplayVisibility.Hidden)]
    ...
    /// <summary>
    /// Configure the information retrieved from IMDb for movie and TV
    /// collections.
    /// </summary>
    [Display(Name = "IMDb")]
    public IMDbSettings IMDb { get; set; } = new();

    /// <summary>
    /// Configure the information retrieved from TVDB for movie and TV
    /// collections.
    /// </summary>
    [Display(Name = "TVDB")]
    ...
    /// <summary>
    /// Configure DaCollector managed movie and TV collections.
    /// </summary>
    [Display(Name = "Collections")]
    public CollectionManagerSettings CollectionManager { get; set; } = new();
    ...
    [EnvironmentVariable("DACOLLECTOR_WEBUI_SETTINGS", AllowOverride = true)]
    ...
    /// </remarks>
    [EnvironmentVariable("DACOLLECTOR_DUMP_SETTINGS_ON_START")]
