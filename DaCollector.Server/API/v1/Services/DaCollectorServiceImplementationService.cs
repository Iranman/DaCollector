...
#nullable enable
namespace DaCollector.Server.API.v1.Services;

public class DaCollectorServiceImplementationService(
    ILogger<DaCollectorServiceImplementationService> _logger,
