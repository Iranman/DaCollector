...
public partial class DaCollectorServiceImplementation
{
    ...
    public CL_Response<CL_AnimeSeries_User> SaveSeries(CL_AnimeSeries_Save_Request contract, int userID)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                DaCollectorEventHandler.Instance.OnSeriesUpdated(series, UpdateReason.Added);
        ...
        bool forceOverwrite)
    {
        ...
        try
        {
            ...
            var refreshMethod = AnidbRefreshMethod.Default | AnidbRefreshMethod.CreateDaCollectorSeries;
    ...
    public CL_Response<CL_ImportFolder> SaveImportFolder(CL_ImportFolder contract)
    {
        ...
        try
        {
            folder.Result = RepoFactory.DaCollectorManagedFolder.SaveFolder(contract.ToServer()).ToClient();
        }
        catch (Exception e)
        {
    ...
    {
        var importFolder = RepoFactory.DaCollectorManagedFolder.GetByID(importFolderID);
