...
using DaCollector.Server.API.v1.Models.Metro;
...
public class DaCollectorServiceImplementationMetro : IHttpContextAccessor
{
    private readonly DaCollectorServiceImplementation _service;

    private readonly ISettingsProvider _settingsProvider;

    private readonly IUserDataService _userDataService;

    private readonly DaCollectorServiceImplementationService _legacyV1Service;
    ...
    public DaCollectorServiceImplementationMetro(
        ISettingsProvider settingsProvider,
        DaCollectorServiceImplementation service,
