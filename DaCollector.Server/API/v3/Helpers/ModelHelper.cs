...
using GroupSizes = DaCollector.Server.API.v3.Models.DaCollector.GroupSizes;
using SeriesSizes = DaCollector.Server.API.v3.Models.DaCollector.SeriesSizes;

#nullable enable
namespace DaCollector.Server.API.v3.Helpers;
