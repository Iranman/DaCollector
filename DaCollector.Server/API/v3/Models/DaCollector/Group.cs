...
/// <summary>
/// Group object, stores all of the group info. Groups are DaCollector Internal Objects, so they are handled a bit differently
/// </summary>
public class Group : BaseModel
{
    ...
    public class GroupIDs : IDs
    {
        ...
        /// <summary>
        /// The ID of the main DaCollector series for the group.
        /// </summary>
        /// <value></value>
        [Required]
