...
using ApiRelocationPipe = DaCollector.Server.API.v3.Models.Relocation.RelocationPipe;
using ApiRelocationResult = DaCollector.Server.API.v3.Models.Relocation.RelocationResult;
using RelocationPipe = DaCollector.Abstractions.Video.Relocation.RelocationPipe;
