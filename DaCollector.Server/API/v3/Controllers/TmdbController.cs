...
using File = DaCollector.Server.API.v3.Models.DaCollector.File;
...
public partial class TmdbController : BaseController
{
    ...
    /// <summary>
    /// Get all DaCollector series linked to a TMDB movie.
    /// </summary>
    /// <param name="movieID">TMDB Movie ID.</param>
    ...
    /// <returns></returns>
    [HttpGet("Movie/{movieID}/DaCollector/Series")]
    public ActionResult<List<Series>> GetDaCollectorSeriesByTmdbMovieID(
        [FromRoute] int movieID,
    ...
    /// <summary>
    /// Get all DaCollector episodes linked to a TMDB movie.
    /// </summary>
    /// <param name="movieID">TMDB Movie ID.</param>
    /// <param name="includeDataFrom">Include data from selected <see cref="DataSourceType"/>s.</param>
    /// <returns></returns>
    [HttpGet("Movie/{movieID}/DaCollector/Episode")]
    public ActionResult<List<Episode>> GetDaCollectorEpisodesByTmdbMovieID(
        [FromRoute] int movieID,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] HashSet<DataSourceType>? includeDataFrom = null
    )
    {
    ...
    /// <returns></returns>
    [HttpGet("Movie/{movieID}/DaCollector/File")]
    public ActionResult<ListResult<File>> GetDaCollectorFilesByMovieID(
        [FromRoute] int movieID,
    ...
    /// <summary>
    /// Get all DaCollector series linked to a TMDB show.
    /// </summary>
    /// <param name="showID">TMDB Show ID.</param>
    /// <param name="randomImages">Randomize images shown for the <see cref="Series"/>.</param>
    /// <param name="includeDataFrom">Include data from selected <see cref="DataSourceType"/>s.</param>
    /// <returns></returns>
    [HttpGet("Show/{showID}/DaCollector/Series")]
    public ActionResult<List<Series>> GetDaCollectorSeriesByTmdbShowID(
        [FromRoute] int showID,
        [FromQuery] bool randomImages = false,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] HashSet<DataSourceType>? includeDataFrom = null
    )
    ...
    /// <param name="sortOrder">Sort ordering. Attach '-' at the start to reverse the order of the criteria.</param>
    /// <returns></returns>
    [HttpGet("Show/{showID}/DaCollector/File")]
    public ActionResult<ListResult<File>> GetDaCollectorFilesByTmdbShowID(
        [FromRoute] int showID,
        [FromQuery, Range(0, 1000)] int pageSize = 100,
        [FromQuery, Range(1, int.MaxValue)] int page = 1,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] FileNonDefaultIncludeType[]? include = null,
    ...
    [HttpGet("Season/{seasonID}/DaCollector/Series")]
    public ActionResult<List<Series>> GetDaCollectorSeriesBySeasonID(
        [FromRoute, RegularExpression(SeasonIdRegex)] string seasonID,
        [FromQuery] bool randomImages = false,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] HashSet<DataSourceType>? includeDataFrom = null
    )
    ...
    /// <param name="sortOrder">Sort ordering. Attach '-' at the start to reverse the order of the criteria.</param>
    /// <returns></returns>
    [HttpGet("Season/{seasonID}/DaCollector/File")]
    public ActionResult<ListResult<File>> GetDaCollectorFilesBySeasonID(
        [FromRoute, RegularExpression(SeasonIdRegex)] string seasonID,
        [FromQuery, Range(0, 1000)] int pageSize = 100,
        [FromQuery, Range(1, int.MaxValue)] int page = 1,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] FileNonDefaultIncludeType[]? include = null,
    ...
    [HttpGet("Episode/{episodeID}/DaCollector/Series")]
    public ActionResult<List<Series>> GetDaCollectorSeriesByEpisodeID(
        [FromRoute] int episodeID,
        [FromQuery] bool randomImages = false,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] HashSet<DataSourceType>? includeDataFrom = null
    )
    ...
    [HttpGet("Episode/{episodeID}/DaCollector/Episode")]
    public ActionResult<List<Episode>> GetDaCollectorEpisodesByEpisodeID(
        [FromRoute] int episodeID,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] HashSet<DataSourceType>? includeDataFrom = null
    )
    {
    ...
    /// <param name="sortOrder">Sort ordering. Attach '-' at the start to reverse the order of the criteria.</param>
    /// <returns></returns>
    [HttpGet("Episode/{episodeID}/DaCollector/File")]
    public ActionResult<ListResult<File>> GetDaCollectorFilesByEpisodeID(
        [FromRoute] int episodeID,
        [FromQuery, Range(0, 1000)] int pageSize = 100,
        [FromQuery, Range(1, int.MaxValue)] int page = 1,
        [FromQuery, ModelBinder(typeof(CommaDelimitedModelBinder))] FileNonDefaultIncludeType[]? include = null,
