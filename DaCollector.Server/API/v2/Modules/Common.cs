...
using DaCollector.Server.API.v2.Models.common;
...
using APIFilters = DaCollector.Server.API.v2.Models.common.Filters;
...
public class Common : BaseController
{
    ...
    {
        return RepoFactory.DaCollectorManagedFolder.GetAll().Select(a => a.ToClient()).ToList();
    }
    ...
    {
        var count = new Counter { count = RepoFactory.DaCollectorManagedFolder.GetAll().Count };
        return count;
    }
    ...
    public ActionResult<CL_ImportFolder> AddFolder(CL_ImportFolder folder)
    {
        ...
        try
        {
            var result = RepoFactory.DaCollectorManagedFolder.SaveFolder(folder.ToServer());
    ...
    public ActionResult<CL_ImportFolder> EditFolder(CL_ImportFolder folder)
    {
        ...
        try
        {
            var response = RepoFactory.DaCollectorManagedFolder.SaveFolder(folder.ToServer());
    ...
    public async Task<ActionResult> DeleteFolder(int folderId)
    {
        ...
        var importFolder = RepoFactory.DaCollectorManagedFolder.GetByID(folderId);
