...
using DaCollector.Server.Providers.AniDB.UDP.Connection;
...
namespace DaCollector.Server.Providers.AniDB.UDP;
...
public partial class AniDBUDPConnectionHandler : ConnectionHandler, IUDPConnectionHandler
{
    ...
    ****/
    ...
    {
        ObjectDisposedException.ThrowIf(_socketHandler is not { IsConnected: true }, "The connection was closed by dacollector");
