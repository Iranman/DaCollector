...
using DaCollector.Server.Databases.SqliteFixes;
...
public class SQLite(SystemService systemService) : BaseDatabase<SqliteConnection>(systemService)
{
    ...
    [
        ...
        new(  1, 102, "CREATE TABLE AnimeEpisode_User( AnimeEpisode_UserID INTEGER PRIMARY KEY AUTOINCREMENT, JMMUserID INTEGER NOT NULL, AnimeEpisodeID INTEGER NOT NULL, MediaSeriesID INTEGER NOT NULL, WatchedDate DATETIME NULL, PlayedCount INTEGER NOT NULL, WatchedCount INTEGER NOT NULL, StoppedCount INTEGER NOT NULL );"),
        ...
        new(  1, 105, "CREATE TABLE AnimeSeries_User( AnimeSeries_UserID INTEGER PRIMARY KEY AUTOINCREMENT, JMMUserID INTEGER NOT NULL, MediaSeriesID INTEGER NOT NULL, UnwatchedEpisodeCount INTEGER NOT NULL, WatchedEpisodeCount INTEGER NOT NULL, WatchedDate DATETIME NULL, PlayedCount INTEGER NOT NULL, WatchedCount INTEGER NOT NULL, StoppedCount INTEGER NOT NULL ); "),
        new(  1, 106, "CREATE UNIQUE INDEX UIX_AnimeSeries_User_User_SeriesID ON AnimeSeries_User(JMMUserID, MediaSeriesID);"),
        new(  1, 107, "CREATE TABLE AnimeGroup_User( AnimeGroup_UserID INTEGER PRIMARY KEY AUTOINCREMENT, JMMUserID INTEGER NOT NULL, MediaGroupID INTEGER NOT NULL, IsFave INTEGER NOT NULL, UnwatchedEpisodeCount INTEGER NOT NULL, WatchedEpisodeCount INTEGER NOT NULL, WatchedDate DATETIME NULL, PlayedCount INTEGER NOT NULL, WatchedCount INTEGER NOT NULL, StoppedCount INTEGER NOT NULL ); "),
    ...
    [
        ...
        new( 13,  1, "ALTER TABLE MediaSeries ADD SeriesNameOverride text"),
        ...
        new( 41,  1, "ALTER TABLE MediaSeries ADD DefaultFolder TEXT NULL"),
        ...
        new( 44,  5, "ALTER TABLE MediaGroup ADD ContractVersion INTEGER NOT NULL DEFAULT 0"),
        new( 44,  6, "ALTER TABLE MediaGroup ADD LatestEpisodeAirDate DATETIME NULL"),
        new( 44,  7, "ALTER TABLE MediaGroup ADD ContractBlob BLOB NULL"),
        new( 44,  8, "ALTER TABLE MediaGroup ADD ContractSize INTEGER NOT NULL DEFAULT 0"),
        ...
        new( 44, 12, "ALTER TABLE MediaSeries ADD ContractVersion INTEGER NOT NULL DEFAULT 0"),
        new( 44, 13, "ALTER TABLE MediaSeries ADD LatestEpisodeAirDate DATETIME NULL"),
        new( 44, 14, "ALTER TABLE MediaSeries ADD ContractBlob BLOB NULL"),
        new( 44, 15, "ALTER TABLE MediaSeries ADD ContractSize INTEGER NOT NULL DEFAULT 0"),
        ...
        new( 44, 27, "ALTER TABLE MediaEpisode ADD PlexContractVersion INTEGER NOT NULL DEFAULT 0"),
        new( 44, 28, "ALTER TABLE MediaEpisode ADD PlexContractBlob BLOB NULL"),
        new( 44, 29, "ALTER TABLE MediaEpisode ADD PlexContractSize INTEGER NOT NULL DEFAULT 0"),
        ...
        new( 57,  3),
        new( 58,  1, "ALTER TABLE MediaSeries ADD AirsOn TEXT NULL"),
        ...
        new( 74,  1),
        new( 75,  1),
        new( 76,  1, "ALTER TABLE MediaSeries ADD UpdatedAt DATETIME NOT NULL DEFAULT '2000-01-01 00:00:00'"),
        new( 77,  1),
        ...
        new( 85,  1, "ALTER TABLE MediaGroup ADD MainAniDBAnimeID INTEGER DEFAULT NULL;"),
        ...
        new( 94,  1, "ALTER TABLE MediaEpisode ADD IsHidden integer NOT NULL DEFAULT 0;"),
        ...
        new( 97,  2, "ALTER TABLE MediaSeries ADD DisableAutoMatchFlags integer NOT NULL DEFAULT 0;"),
        ...
        new(100,  1, "ALTER TABLE MediaSeries ADD HiddenMissingEpisodeCount integer NOT NULL DEFAULT 0;"),
        new(100,  2, "ALTER TABLE MediaSeries ADD HiddenMissingEpisodeCountGroups integer NOT NULL DEFAULT 0;"),
        ...
        new(104,  2, DatabaseFixes.FixOrphanedDaCollectorEpisodes),
        ...
        new(106,  1, "ALTER TABLE MediaGroup DROP COLUMN SortName;"),
        new(107,  1, "ALTER TABLE MediaEpisode DROP COLUMN PlexContractVersion;ALTER TABLE MediaEpisode DROP COLUMN PlexContractBlob;ALTER TABLE MediaEpisode DROP COLUMN PlexContractSize;ALTER TABLE AnimeGroup_User DROP COLUMN PlexContractVersion;ALTER TABLE AnimeGroup_User DROP COLUMN PlexContractBlob;ALTER TABLE AnimeGroup_User DROP COLUMN PlexContractSize;ALTER TABLE AnimeSeries_User DROP COLUMN PlexContractVersion;ALTER TABLE AnimeSeries_User DROP COLUMN PlexContractBlob;ALTER TABLE AnimeSeries_User DROP COLUMN PlexContractSize;"),
        ...
        new(110,  1, "ALTER TABLE MediaEpisode ADD EpisodeNameOverride text"),
        ...
        new(112,  2, "ALTER TABLE MediaSeries DROP COLUMN ContractVersion;ALTER TABLE MediaSeries DROP COLUMN ContractBlob;ALTER TABLE MediaSeries DROP COLUMN ContractSize;"),
        new(112,  3, "ALTER TABLE MediaGroup DROP COLUMN ContractVersion;ALTER TABLE MediaGroup DROP COLUMN ContractBlob;ALTER TABLE MediaGroup DROP COLUMN ContractSize;"),
        ...
        new(144,  1, "ALTER TABLE MediaSeries ADD COLUMN TVDB_ShowID INTEGER NULL;"),
        new(144,  2, "ALTER TABLE MediaSeries ADD COLUMN TVDB_MovieID INTEGER NULL;"),
        new(144,  3, "ALTER TABLE MediaSeries ADD COLUMN TMDB_ShowID INTEGER NULL;"),
        new(144,  4, "ALTER TABLE MediaSeries ADD COLUMN TMDB_MovieID INTEGER NULL;"),
        ...
        // v145: rename _User tables and AnimeEpisodeID column to remove Anime prefix
        new(145,  1, "ALTER TABLE AnimeEpisode_User RENAME TO MediaEpisode_User;"),
        new(145,  2, "ALTER TABLE AnimeGroup_User RENAME TO MediaGroup_User;"),
        new(145,  3, "ALTER TABLE AnimeSeries_User RENAME TO MediaSeries_User;"),
        new(145,  4, "ALTER TABLE MediaEpisode RENAME COLUMN AnimeEpisodeID TO MediaEpisodeID;"),
        new(145,  5, "ALTER TABLE MediaEpisode_User RENAME COLUMN AnimeEpisode_UserID TO MediaEpisode_UserID;"),
    ...
    private static Tuple<bool, string> DropAnimeEpisode_UserColumns(object connection)
    {
        try
        {
            ...
            factory.DropColumns(
                ...
                """,
                [
                    "CREATE INDEX IX_AnimeEpisode_User_User_AnimeSeriesID on AnimeEpisode_User (JMMUserID, MediaSeriesID);",
