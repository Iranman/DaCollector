...
public class SQLite(SystemService systemService) : BaseDatabase<SqliteConnection>(systemService)
{
    ...
    [
        ...
        // v145: rename domain tables and columns to remove Anime prefix
        ...
        new(145,  4, "ALTER TABLE AnimeEpisode RENAME TO MediaEpisode;"),
        new(145,  5, "ALTER TABLE AnimeGroup RENAME TO MediaGroup;"),
        new(145,  6, "ALTER TABLE AnimeSeries RENAME TO MediaSeries;"),
        new(145,  7, "ALTER TABLE MediaEpisode RENAME COLUMN AnimeEpisodeID TO MediaEpisodeID;"),
        new(145,  8, "ALTER TABLE MediaEpisode RENAME COLUMN AnimeSeriesID TO MediaSeriesID;"),
        new(145,  9, "ALTER TABLE MediaEpisode_User RENAME COLUMN AnimeEpisode_UserID TO MediaEpisode_UserID;"),
        new(145, 10, "ALTER TABLE MediaEpisode_User RENAME COLUMN AnimeEpisodeID TO MediaEpisodeID;"),
        new(145, 11, "ALTER TABLE MediaEpisode_User RENAME COLUMN AnimeSeriesID TO MediaSeriesID;"),
        new(145, 12, "ALTER TABLE MediaGroup RENAME COLUMN AnimeGroupID TO MediaGroupID;"),
        new(145, 13, "ALTER TABLE MediaGroup RENAME COLUMN AnimeGroupParentID TO MediaGroupParentID;"),
        new(145, 14, "ALTER TABLE MediaGroup RENAME COLUMN DefaultAnimeSeriesID TO DefaultMediaSeriesID;"),
        new(145, 15, "ALTER TABLE MediaGroup_User RENAME COLUMN AnimeGroup_UserID TO MediaGroup_UserID;"),
        new(145, 16, "ALTER TABLE MediaGroup_User RENAME COLUMN AnimeGroupID TO MediaGroupID;"),
        new(145, 17, "ALTER TABLE MediaSeries RENAME COLUMN AnimeSeriesID TO MediaSeriesID;"),
        ...
        new(155,  1, "ALTER TABLE MediaGroup ADD COLUMN TmdbCollectionID INTEGER NULL;"),
    ];
