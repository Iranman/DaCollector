...
public class MySQL(SystemService systemService) : BaseDatabase<MySqlConnection>(systemService)
{
    ...
    [
        ...
        // v163: rename domain tables and columns to remove Anime prefix
        ...
        new(163,  4, "RENAME TABLE `AnimeEpisode` TO `MediaEpisode`;"),
        new(163,  5, "RENAME TABLE `AnimeGroup` TO `MediaGroup`;"),
        new(163,  6, "RENAME TABLE `AnimeSeries` TO `MediaSeries`;"),
        new(163,  7, "ALTER TABLE `MediaEpisode` RENAME COLUMN `AnimeEpisodeID` TO `MediaEpisodeID`;"),
        new(163,  8, "ALTER TABLE `MediaEpisode` RENAME COLUMN `AnimeSeriesID` TO `MediaSeriesID`;"),
        new(163,  9, "ALTER TABLE `MediaEpisode_User` RENAME COLUMN `AnimeEpisode_UserID` TO `MediaEpisode_UserID`;"),
        new(163, 10, "ALTER TABLE `MediaEpisode_User` RENAME COLUMN `AnimeEpisodeID` TO `MediaEpisodeID`;"),
        new(163, 11, "ALTER TABLE `MediaEpisode_User` RENAME COLUMN `AnimeSeriesID` TO `MediaSeriesID`;"),
        new(163, 12, "ALTER TABLE `MediaGroup` RENAME COLUMN `AnimeGroupID` TO `MediaGroupID`;"),
        new(163, 13, "ALTER TABLE `MediaGroup` RENAME COLUMN `AnimeGroupParentID` TO `MediaGroupParentID`;"),
        new(163, 14, "ALTER TABLE `MediaGroup` RENAME COLUMN `DefaultAnimeSeriesID` TO `DefaultMediaSeriesID`;"),
        new(163, 15, "ALTER TABLE `MediaGroup_User` RENAME COLUMN `AnimeGroup_UserID` TO `MediaGroup_UserID`;"),
        new(163, 16, "ALTER TABLE `MediaGroup_User` RENAME COLUMN `AnimeGroupID` TO `MediaGroupID`;"),
        new(163, 17, "ALTER TABLE `MediaSeries` RENAME COLUMN `AnimeSeriesID` TO `MediaSeriesID`;"),
