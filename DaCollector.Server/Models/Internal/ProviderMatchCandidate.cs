...
/// <summary>
/// A candidate provider match for a MediaSeries, pending user review.
/// </summary>
public class ProviderMatchCandidate
{
    public int ProviderMatchCandidateID { get; set; }
    ...
    /// <summary>Confidence score in [0, 1] derived from title similarity and year match.</summary>
