...
public class TMDB_AlternateOrdering_Episode : TMDB_Base<string>, ITmdbEpisode, ITmdbEpisodeOrderingInformation
{
    ...
    IReadOnlyList<int> IEpisode.DaCollectorEpisodeIDs => GetTmdbEpisode().DaCollectorEpisodeIDs;
    ...
    IReadOnlyList<IDaCollectorEpisode> IEpisode.DaCollectorEpisodes => GetTmdbEpisode().DaCollectorEpisodes;
