...
public class VideoLocal_Place : IVideoFile
{
    ...
    /// <see cref="DaCollectorManagedFolder"/>. It will always use forward slashes (/)
    ...
    /// <summary>
    /// Helper to get the <see cref="DaCollectorManagedFolder"/> linked to the file location.
    /// </summary>
    public DaCollectorManagedFolder? ManagedFolder
        => ManagedFolderID is 0 ? null : RepoFactory.DaCollectorManagedFolder.GetByID(ManagedFolderID);
