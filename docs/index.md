...
The current engineering focus is compile stability, append-only database migrations, and finishing the `MediaSeries` / `MediaGroup` / `MediaEpisode` domain rename. See [Current Work](development/current-work.md) for the active contributor checklist.
